...
@XmlType(name = "ContentInfo",
         propOrder =
         { "dDocName", "dDocTitle", "dDocType", "dDocAuthor", "dSecurityGroup", "dDocAccount", "did", "dRevClassID",
           "dRevisionID", "dRevLabel", "dIsCheckedOut", "dCheckoutUser", "dCreateDate", "dInDate", "dOutDate",
           "dStatus", "dReleaseState", "dFlag1", "dWebExtension", "dProcessingState", "dMessage", "dReleaseDate",
           "dRendition1", "dRendition2", "dIndexerState", "dPublishType", "dPublishState", "dDocID", "dIsPrimary",
           "dIsWebFormat", "dLocation", "dOriginalName", "dFormat", "dExtension", "dFileSize", "customDocMetaData"
    })
